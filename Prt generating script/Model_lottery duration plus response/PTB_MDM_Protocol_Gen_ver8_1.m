function PTB_MDM_Protocol_Gen_ver8_1(subjectNum, domain, tr, trialduration, DiscAcq, ParametricMod, path_in, path_out, PRT, tpb)
...
permissible_parameters = {'RewardValue', 'SV','CV','CR'}; % CV-Chosen Subjective value, CR-Chosen Reward magnitude, CRating-chosen subjective rating
