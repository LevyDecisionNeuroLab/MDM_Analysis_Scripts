function PTB_MDM_Protocol_Gen_ver7(subjectNum, domain, tr, trialduration, DiscAcq, ParametricMod, path_in, path_out, PRT, tpb)
...
permissible_parameters = {'RewardValue', 'RiskLevel', 'AmbiguityLevel', 'SubjRating','SV','CV','CR'}; % CV means Chosen Subjective value, CR means Chosen Reward magnitude
...
for blocknum = 1:4
  ...
  fname = [path_out num2str(subjectNum) '_block' block_order{blocknum} ...
      '_' domain num2str(blocknum) '_model_dispresp' '_type_' ParametricMod '.prt'];
