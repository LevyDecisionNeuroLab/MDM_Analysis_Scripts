...
%% Define conditions
fitparwave = 'Behavior data fitpar_1226012017';
fitbyrating = true;
...
if ~fitbyrating
    ...
    fprintf(fid1,'\tbeta\tbetase\tgamma\tgammase\tLL\tr2\tAIC\tBIC\tmodel\texitFlag\toptimizer\n')
else
    fprintf(fid1,'subject\tmonetary\t\t\t\t\t\t\t\t\t\t\tmedical\n')
    fprintf(fid1,'\tbeta\tbetase\tgamma\tgammase\tLL\tr2\tAIC\tBIC\tmodel\texitFlag\toptimizer\tbeta\tbetase\tgamma\tgammase\tLL\tr2\tAIC\tBIC\tmodel\texitFlag\toptimizer\n')
end
...
%     svRefP = Datamon.svRef;
    ...
    if fitbyrating
        ...
        fprintf(fid1,'%s\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%s\t%f\t%s\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%s\t%f\t%s\n',...
                num2str(subject),betaP,betaseP,gammaP,gammaseP,LLP,r2P,AICP,BICP,modelP,exitFlagP,optimizerP,...
                                 betaN,betaseN,gammaN,gammaseN,LLN,r2N,AICN,BICN,modelN,exitFlagN,optimizerN)
    else
        %write into param text file
